# Generated by Django 3.2.14 on 2024-05-05 13:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobileNumber', models.CharField(default='', max_length=25)),
                ('country', models.CharField(default='', max_length=50)),
                ('city', models.CharField(default='', max_length=50)),
                ('sex', models.CharField(choices=[(1, 'Man'), (2, 'Woman')], max_length=20)),
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_groups', related_query_name='user', to='auth.Permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qrCode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='users.qrcode')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
